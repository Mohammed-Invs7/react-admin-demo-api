          ...
          <div>
            ...
            <div className='flex gap-1'>
              ...
              >
                ...
                <p className='mt-4'>{t('clerk.learnMoreSignOut')}</p>
              </LearnMore>
            </div>
          </div>
          <UsersPrimaryButtons />
  ...
  return (
    <div className='h-svh'>
      <div className='m-auto flex h-full w-full flex-col items-center justify-center gap-2'>
        ...
        <span className='font-medium'>{t('clerk.unauthorizedAccess')}</span>
        <p className='text-center text-muted-foreground'>
          {t('clerk.mustAuthClerk')}{' '}
          <sup>
            <LearnMore open={opened} onOpenChange={setOpened}>
              ...
              <p>{t('clerk.unauthorizedLearnMoreSignIn')}</p>

              <p className='mt-4'>{t('clerk.unauthorizedLearnMoreProfile')}</p>
            </LearnMore>
          </sup>
          <br />
          {t('clerk.accessResource')}
        </p>
        <div className='mt-6 flex gap-4'>
          ...
          <Button onClick={() => navigate({ to: '/clerk/sign-in' })}>
            <ClerkLogo className='invert' /> {t('nav.items.signIn')}
          </Button>
        </div>
        <div className='mt-4 h-8 text-center'>
          {!cancelled && !opened && (
            <>
              <p>
                {countdown > 0
                  ? t('clerk.redirecting', { count: countdown })
                  : t('clerk.redirectingShort')}
              </p>
