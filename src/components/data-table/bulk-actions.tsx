...
export function DataTableBulkActions<TData>({
  ...
  useEffect(() => {
    if (selectedCount > 0) {
      const message = t('dataTable.bulkSelectedAnnouncement', {
        count: selectedCount,
        entity: entityName,
      })
  ...
  return (
    <>
      ...
      <div
        ref={toolbarRef}
        role='toolbar'
        aria-label={t('dataTable.bulkActionsFor', {
          count: selectedCount,
          entity: entityName,
        })}
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <Button
                ...
                title={t('dataTable.clearSelectionTooltip')}
              >
                <X />
            ...
            <TooltipContent>
              <p>{t('dataTable.clearSelectionTooltip')}</p>
            </TooltipContent>
          </Tooltip>
