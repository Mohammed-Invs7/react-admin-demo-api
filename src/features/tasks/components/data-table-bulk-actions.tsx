            ...
            <TooltipTrigger asChild>
              <DropdownMenuTrigger asChild>
                <Button
                  ...
                  size='icon'
                  className='size-8'
                  aria-label={t('tasks.bulk.status')}
                  title={t('tasks.bulk.status')}
                >
                  <CircleArrowUp />
                  <span className='sr-only'>{t('tasks.bulk.status')}</span>
                </Button>
              </DropdownMenuTrigger>
            </TooltipTrigger>
            <TooltipContent>
              <p>{t('tasks.bulk.status')}</p>
            </TooltipContent>
          </Tooltip>
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <DropdownMenuTrigger asChild>
                ...
                >
                  <ArrowUpDown />
                  <span className='sr-only'>{t('tasks.priority')}</span>
                </Button>
              </DropdownMenuTrigger>
            </TooltipTrigger>
            <TooltipContent>
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <Button
              ...
              className='size-8'
              aria-label={t('tasks.bulk.export')}
              title={t('tasks.bulk.export')}
            >
              <Download />
              <span className='sr-only'>{t('tasks.bulk.export')}</span>
            </Button>
          </TooltipTrigger>
          <TooltipContent>
            <p>{t('tasks.bulk.export')}</p>
          </TooltipContent>
        </Tooltip>
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <Button
              ...
              className='size-8'
              aria-label={t('tasks.bulk.delete')}
              title={t('tasks.bulk.delete')}
            >
              <Trash2 />
              <span className='sr-only'>{t('tasks.bulk.delete')}</span>
            </Button>
          </TooltipTrigger>
          <TooltipContent>
            <p>{t('tasks.bulk.delete')}</p>
          </TooltipContent>
        </Tooltip>
      </BulkActionsToolbar>
